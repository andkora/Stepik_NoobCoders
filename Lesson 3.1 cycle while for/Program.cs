...
/*
 * Задача 8
Это творческое задание. Необходимо написать программу, которая рисует в консоли ёлочку из звездочек, 
высота ёлочки вводится пользователем в консоль. 
Обратите внимание, что первый символ в основании ёлочки это первый символ данной строки, 
а ее вершина находится на первой строке
*/
/*
...
*/
/*
Задача 9 Шаг 14 -не решена
Дядя Вася ушел в поход в половине первого после полудня и должен успеть вернуться домой к вечеру,
чтобы посмотреть интересный сериал. Он даже взял с собой свои любимые наручные часы, но оказалось, 
что у них отсутствуют стрелки. Зато часы издают характерный щелчок каждый раз в тот момент, 
когда минутная стрелка должна была бы опередить часовую на 30 градусов. Помогите ему определить время с точностью до минуты, 
если часы только что щелкнули уже n-ый раз с момента его ухода. Число n вводится в консоль.
Пример: 
n=1 - 1:10;
n=5 - 5:32;
Каждый щелчок равен 65,5 минуты.
...
switch (n)
{
    ...
    case 1:
        hour = 1;
        minute = 10;
        Console.WriteLine(hour + ":" + minute); break;
    case 0:
        break;
